...
if __name__ == "__main__":
    ...
    parser.add_argument("--hist_size", type=int, default=0, help="Number of timesteps to stack when getting data from dataset (only applicable if `tcn_*` model is used )")
    parser.add_argument("--visual_extractor", type=str, default="tcn", choices=["frontnet", "mobilenet"], help="Type of model to use")
